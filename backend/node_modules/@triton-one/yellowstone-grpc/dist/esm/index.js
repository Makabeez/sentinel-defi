...
import { GetBlockHeightResponse as GetBlockHeightResponseMessage, GetLatestBlockhashResponse as GetLatestBlockhashResponseMessage, GetSlotResponse as GetSlotResponseMessage, GetVersionResponse as GetVersionResponseMessage, IsBlockhashValidResponse as IsBlockhashValidResponseMessage, PongResponse as PongResponseMessage, SubscribeRequest as SubscribeRequestMessage, SubscribeReplayInfoResponse as SubscribeReplayInfoResponseMessage, SubscribeUpdateTransactionInfo, } from "./grpc/geyser.js";
    ...
    _write(chunk, _encoding, callback) {
        ...
        try {
            ...
            if (typeof nativeStream.writeRaw !== "function") {
                throw new Error("Native stream does not support writeRaw; reinstall the SDK so JS and native bindings match");
            }
