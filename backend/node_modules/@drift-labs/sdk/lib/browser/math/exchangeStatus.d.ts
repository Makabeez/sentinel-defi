...
export declare function isMarketConfigFlagSet(marketConfig: number, flag: MarketConfigFlag): boolean;
export declare function isFormulaicKUpdateDisabled(market: PerpMarketAccount): boolean;
