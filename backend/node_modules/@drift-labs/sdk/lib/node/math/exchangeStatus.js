...
function isMarketConfigFlagSet(marketConfig, flag) {
    return (marketConfig & flag) > 0;
}
exports.isMarketConfigFlagSet = isMarketConfigFlagSet;
function isFormulaicKUpdateDisabled(market) {
    return isMarketConfigFlagSet(market.marketConfig, types_1.MarketConfigFlag.DISABLE_FORMULAIC_K_UPDATE);
}
exports.isFormulaicKUpdateDisabled = isFormulaicKUpdateDisabled;
