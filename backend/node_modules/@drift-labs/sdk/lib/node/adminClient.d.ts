...
export declare class AdminClient extends DriftClient {
    ...
    adminWithdrawFromInsuranceFundVault(marketIndex: number, amount: BN, recipientTokenAccount: PublicKey, txParams?: TxParams): Promise<TransactionSignature>;
    getAdminWithdrawFromInsuranceFundVaultIx(marketIndex: number, amount: BN, recipientTokenAccount: PublicKey): Promise<TransactionInstruction>;
